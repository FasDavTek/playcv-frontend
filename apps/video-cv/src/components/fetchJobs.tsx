...
const fetchJobs: React.FC<FetchJobsProps> = ({ filterOptions }) => {
  ...
  return (
    <div className='space-y-4'>
      <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 justify-items-center md:justify-items-start`} style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))' }}>
