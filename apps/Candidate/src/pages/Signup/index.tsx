...
//       nyscStateCode: z.string().min(1, 'NYSC State code is required'),
...
//         employerInfo: null,
//         professionalInfo: data.hasBusiness ? professionalInfor : null,
//       }
...
//     // if (watchHasBusiness) {
//     //   requiredFields.push("professionalInfo.nyscStateCode", "professionalInfo.nyscStartYear", "professionalInfo.nyscEndYear", "professionalInfo.course", "professionalInfo.classOfDegree")
...
//         <form onSubmit={handleSubmit(submitForm)} className={`${watchHasBusiness ? 'h-full space-y-6' : 'h-auto'}`}>
...
//                       isValid={!errors?.professionalInfo?.businessPhone && !!watchedFields.professionalInfo.businessPhone}
//                     />
//                   </div>
//                   <div>
//                     <Controller
...
//                           defaultValue={Array.isArray(institutions) &&  institutions?.find(i => i.name === watch('professionalInfo.institution'))}
...
//                       isValid={!errors?.professionalInfo?.nyscStateCode && !!watchedFields?.professionalInfo?.nyscStateCode}
//                     />
//                   </div>
//                   <div>
//                     <Controller
...
//                           control={control}
//                           defaultValue={Array.isArray(industry) && industry?.find(i => i.name === watch('professionalInfo.industry'))}
...
//               onClick={() => console.log("Button clicked", { loading, isFormValid })}
//             />
//           </div>
//         </form>
