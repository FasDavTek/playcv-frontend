...
import { AdPlayer, Button, HtmlContent, useToast } from '@video-cv/ui-components';
  ...
  return (
    <Stack direction={{ sm: 'column', md: 'row' }} gap={3} className="min-h-screen flex-col md:flex-row mx-auto py-4 px-3 md:px-7 w-[98%]">
      <Stack direction="column" flex={4} spacing={3}>
        <ChevronLeftIcon className="cursor-pointer mr-1 top-0 p-1 hover:text-white hover:bg-black rounded-full" sx={{ fontSize: '2rem' }} onClick={handleBackClick} />
      ...
      <Box className={`flex-col lg:w-[30%] gap-4 lg:flex hidden`}>
