  ...
  return (
    <div className='p-6 bg-gray-50 mb-8'>
      ...
      <div className="bg-white p-10 shadow-lg rounded-2xl transform transition-all duration-300">
            ...
            <div className="mb-6">
                <span className="font-semibold text-2xl text-gray-800 align-middle">Business Details</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Business Name:</span> <span className="text-gray-600">{`${user?.businessDetails?.businessName}`}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Business Email Address:</span> <span className="text-gray-600">{`${user?.businessDetails?.businessEmail}`}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Company Website:</span>
                <a href={user?.businessDetails.websiteUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 ml-2 underline transition duration-200 hover:text-blue-800">
                    {user?.businessDetails.websiteUrl}
                </a>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Business Sector:</span>
                <span className="text-gray-600">{user?.businessDetails.industry}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Contact Person:</span> <span className="text-gray-600">{user?.businessDetails.contactName}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Contact Person Position:</span> <span className="text-gray-600">{user?.businessDetails.contactPosition}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Contact Person Phone Number:</span> <span className="text-gray-600">{user?.businessDetails.contactPhone}</span>
            </div>
            
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Company Address</span> <span className="text-gray-600">{user?.businessDetails?.address}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Facebook Link:</span> <span className="text-gray-600">{user?.businessDetails?.fbLink}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Twitter Link:</span> <span className="text-gray-600">{user?.businessDetails?.twitter}</span>
            </div>
            <div className="mb-6">
                <span className="font-semibold text-gray-800">Instagram Link:</span> <span className="text-gray-600">{user?.businessDetails?.instagramUrl}</span>
            </div>
            <div className="mb-6">
