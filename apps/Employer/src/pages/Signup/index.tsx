...
//                     <Input type='text' label="First Name" placeholder="First Name" {...register('firstName')} />
//                     <Input type='text' label="Middle Name" placeholder="Middle Name" {...register('middleName')} />
//                     <Input type='text' label="Surname" placeholder="Surname" {...register('surname')} />
//                     <Input type='text' label="Business Name" placeholder="Business Name" {...register('businessName')} />
//                     <Input type='number' label="Phone Number" placeholder="Phone Number" {...register('phoneNumber')} />
...
//                     <Input type='password' label="Confirm Password" placeholder="Confirm Password" {...register('confirmPassword')} />
//                 </div>
//                 <div className="mt-5">
